...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_8pernnk', 'template_h5um77o', form.current, '_4hMY0LXhh8O3hU0o')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">sayandeb.pi@gmail.com</span>
                        
                        <a href="mailto:sayandeb.pi@gmail.com" className="contact__button">
                            Write Me{" "} 
